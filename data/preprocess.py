"""
KubeSage Preprocessing Pipeline
===============================
...
class IncidentPreprocessor:
    ...
    Attributes:
        severity_encoder: LabelEncoder for severity levels.
        type_encoder: LabelEncoder for incident types.
    """
    ...
    def clean_log_line(log: str) -> str:
        ...
        # Remove hex IDs (container IDs, etc.)
    ...
    def build_incident_text(incident: dict[str, Any]) -> str:
        """
        Build a single text representation from all incident fields.
        This text will be embedded using Sentence Transformers.
    ...
    def preprocess(self, incident: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns:
            Preprocessed incident with cleaned text, encoded features, and chunks.
        """
        # Build raw text
...
def preprocess_incidents(
    ...
    Args:
        ...
        fit_encoders: Whether to fit encoders (True) or use existing (False).
    
    Returns:
        List of preprocessed incident dictionaries.
    """
    ...
    print(f"[OK] Preprocessed {len(preprocessed)} incidents")
...
def main() -> None:
    ...
    print(f"[INFO] Loaded {len(raw_incidents)} raw incidents")
    ...
    print(f"[OK] Saved preprocessed dataset to: {output_path}")
